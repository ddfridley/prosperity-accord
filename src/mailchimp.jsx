    ...
    render() {
      ...
      <div>
        ...
        <div id="mc_embed_signup">
          <form action="http://herokuapp.us16.list-manage.com/subscribe/post?u=bbe2f7aaf960ecd631ddbcd81&id=237d24c1f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" className="validate" target="_blank" noValidate>
            <div id="mc_embed_signup_scroll">
              ...
              <div style={{position: 'absolute', left: '-5000px'}} aria-hidden="true"><input type="text" name="b_bbe2f7aaf960ecd631ddbcd81_237d24c1f0" tabIndex={-1} defaultValue /></div>
